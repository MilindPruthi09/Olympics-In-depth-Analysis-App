...
athlete_data=pd.read_csv("../Olympics Analysis Project/Dataset/athlete_events.csv")
region_data=pd.read_csv("../Olympics Analysis Project/Dataset/noc_regions.csv")

df=preprocessor.preprocess(athlete_data, region_data)
...
if user_menu=='Overall Analysis':
    ...
    x=helper.most_successful_ath(df, selected_sport)
    st.table(x)
...
#     x2=athlete_data[athlete_df['Medal']=='Gold']['Age'].dropna()
#     x3=athlete_data[athlete_df['Medal']=='Silver']['Age'].dropna()
#     x4=athlete_data[athlete_df['Medal']=='Bronze']['Age'].dropna()
